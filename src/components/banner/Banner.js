  ...
  return (
    <section className="banner mb-20">
      <div className="container-base">
        <div>
          <Swiper loop spaceBetween={40} slidesPerView={1} grabCursor={"true"}>
            {banners.length > 0 &&
              banners.map((item) => {
                return (
...
function BannerItem({ item }) {
  ...
  return (
    <div className="w-full h-full rounded-lg relative">
      <div
        className="overlay-banner absolute inset-0 bg-gradient-to-t
      ...
      <div className="absolute bottom-3 left-5 w-full text-white">
        ...
        <div className="flex items-center gap-x-3 mb-5">
          <span
            className="inline-block p-3 border border-white rounded-md text-white text-base
